...
const quizQuestions = [
    ...
    {
        question: "Which collection class allows you to store unique elements and maintains no order?",
        answers: [
    ...
    {
        question: "Which interface provides methods for storing key-value pairs?",
        answers: [
